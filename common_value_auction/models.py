...
class Constants(BaseConstants):
    ...
    cog1DEF = random.randint(1000000,9999999)  # memorystring 1
    cog2DEF = random.randint(1000000,9999999)
    cog3DEF = random.randint(1000000,9999999)
    cog4DEF = random.randint(1000000,9999999)
    cog5DEF = random.randint(1000000,9999999)
    cog6DEF = random.randint(1000000,9999999)
